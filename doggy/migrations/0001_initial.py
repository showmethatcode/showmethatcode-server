...
def add_dog_list(apps, schema_editor):
    ...
    for item in dogs:
        _dog = dog_list.objects.create(
            breed = item['breed'],
            description = item['description'],
            adaptability = item['adaptability'],
            confidence = item['confidence'],
            independence = item['independence'],
            positiveness = item['positiveness'],
            shyness = item['shyness'],
            image = item['image'],
            breed_kr = item['breed_kr'],
...
def add_question_list(apps, schema_editor):
    ...
    for item in questions:
        _question = question_list.objects.create(
...
def add_choice_list(apps, schema_editor):
    ...
    for item in choices:
        _choice = choice_list.objects.create(
            text = item['text'],
            score = item['score'],
